module.exports = [
"[project]/lib/cv-generator.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    if (template === 'modern') {
        ...
        if (data.experience && data.experience.length > 0) {
            ...
            data.experience.forEach((exp)=>{
                ...
                doc.text(`${exp.company || ''} | ${exp.duration || ''}`, pageWidth - 20, y, {
                    align: 'right'
                });
                doc.setTextColor(0, 0, 0);
                y += 8;
        ...
        if (data.education && data.education.length > 0) {
            ...
            data.education.forEach((edu)=>{
                ...
                doc.setFont("helvetica", "normal");
                doc.setTextColor(100, 100, 100);
                doc.text(`${edu.institution || ''} | ${edu.year || ''}`, pageWidth - 20, y, {
                    align: 'right'
                });
                doc.setTextColor(0, 0, 0);
                y += 8;
        ...
        doc.text(data.personal?.name || 'Votre nom', pageWidth / 2, y, {
            align: 'center'
        });
        y += 8;
        doc.setFontSize(11);
        doc.setFont("times", "normal");
        doc.text(`${data.personal?.email || ''} | ${data.personal?.phone || ''} | ${data.personal?.city || ''}`, pageWidth / 2, y, {
            align: 'center'
        });
        y += 15;
...
//# sourceMappingURL=lib_cv-generator_ts_129ba5b4._.js.map