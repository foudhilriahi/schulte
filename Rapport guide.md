# RAPPORT_GUIDE.md — Schulte Tunisia PFE
# Comment ecrire le rapport sans plagia ni detection IA
# Structure exacte selon Guide_PFE.docx

---

## LES OUTILS GRATUITS — utilise les dans cet ordre

### Etape 1 — Tu ecris d'abord (meme imparfait)
Ecris une version brouillon dans ta langue naturelle, avec tes mots.
Meme si c'est court et approximatif. C'est ta base.

### Etape 2 — Humaniser et reformuler
Ces outils sont gratuits avec des limites quotidiennes :

**QuillBot** (quillbot.com)
- Mode : "Paraphrase" → choisir le mode "Creative" ou "Fluency"
- Gratuit : 125 mots par passage
- Astuce : coupe ton texte en blocs de 100 mots, traite-les un par un
- Resultat : reformule completement la phrase tout en gardant le sens

**WordTune** (wordtune.com)
- Gratuit : 10 reformulations par jour
- Meilleur pour : reformuler des phrases techniques de facon naturelle
- Astuce : utilise pour les phrases ou tu as "traduit" de l'anglais

**Undetectable.ai** (undetectable.ai)
- Gratuit : version limitee
- Specifiquement fait pour rendre du texte IA non-detectable
- Utilise en dernier apres avoir reformule avec QuillBot

**Smodin** (smodin.io)
- Paraphraseur gratuit, supporte le francais
- Bonus : a aussi un "AI Detector" pour tester ton texte avant soumission

### Etape 3 — Verifier avant de soumettre
- **Scribbr Plagiarism Checker** (scribbr.com) — gratuit une fois
- **Duplichecker** (duplichecker.com) — gratuit, illimite mais basique
- **GPTZero** (gptzero.me) — detecteur IA, gratuit 5000 mots/mois
- **ZeroGPT** (zerogpt.com) — gratuit illimite, colle ton texte et teste

---

## STRATEGIE D'ECRITURE ANTI-DETECTION

### Regle 1 — Commence toujours par "Nous avons"
Les detecteurs IA cherchent la voix passive impersonnelle.
"Dans le cadre de ce projet, nous avons developpe..." est humain.
"Cette application a ete developpee pour resoudre..." est detecte comme IA.

### Regle 2 — Ajoute des details specifiques a Schulte
Des chiffres, des noms, des dates reelles que seul toi connais :
"L'usine de Bouarada, fondee en 2012 et employant environ 180 personnes..."
Ces details ne peuvent pas venir d'une IA — ils te protegent.

### Regle 3 — Inclus des imperfections naturelles
Une phrase un peu longue par-ci, une transition un peu abrupte par-la.
Les humains ne sont pas parfaits. Un texte trop fluide et structure
declenche les detecteurs.

### Regle 4 — Varie la longueur des phrases
Pas toutes les memes. Courtes. Puis une phrase plus longue qui explique
un concept technique en detail et qui donne l'impression d'une pensee
qui se developpe naturellement. Puis de nouveau court.

### Regle 5 — Utilise la premiere personne du pluriel
"Nous avons choisi", "Notre approche", "Dans notre implementation",
"Nous avons constate que". Jamais "L'auteur a choisi".
